...
npm run dev</code></pre>
        ...
        <p class="text-lg mb-4">Navigate to <i class="bg-highlight px-2 py-1 not-italic text-base">http://localhost:5173/</i> to view the application in your local environment.</p>
        ...
        <p class="text-lg mb-4">
            Main menu is defined at <span class="bg-highlight px-2 py-1 not-italic text-base">src/layout/AppMenu.vue</span> file. Update the <i class="bg-highlight px-2 py-1 not-italic text-base">model</i> property to
            define your own menu items.
        </p>

        <div class="font-semibold text-xl mb-4">Layout Composable</div>
        <p class="text-lg mb-4">
            The <span class="bg-highlight px-2 py-1 not-italic text-base">src/layout/composables/layout.js</span> is a composable that manages the layout state changes including dark mode, PrimeVue theme, menu modes and states. If you
        ...
        <p class="text-lg mb-4">
            CSS variables used in the template derive their values from the PrimeVue styled mode presets, use the files under <span class="bg-highlight px-2 py-1 not-italic text-base">assets/layout/_variables.scss</span> to customize
...
npm install --save-dev @primevue/nuxt-module</code></pre>
        ...
        <p class="text-lg mb-4">Add PrimeVue-Nuxt module to <span class="bg-highlight px-2 py-1 not-italic text-base">nuxt.config.js</span></p>
        <pre class="app-code">
<code>modules: [
    '@primevue/nuxt-module',
        ...
        <p class="text-lg mb-4">
            Add <span class="bg-highlight px-2 py-1 not-italic text-base">tailwindcss-primeui</span> package as a plugin to <span class="bg-highlight px-2 py-1 not-italic text-base">tailwind.config.js</span>
        </p>
        <pre class="app-code">
<code>plugins: [require('tailwindcss-primeui')]</code></pre>

        <p class="text-lg mb-4">Add PrimeVue to in <span class="bg-highlight px-2 py-1 not-italic text-base">nuxt.config.js</span></p>
        <pre class="app-code">
...
primevue: {
    options: {
        ...
        <p class="text-lg mb-4">
            Copy <span class="bg-highlight px-2 py-1 not-italic text-base">src/assets</span> folder and paste them to <span class="bg-highlight px-2 py-1 not-italic text-base">assets</span> folder to your Nuxt project.
            And add to <span class="bg-highlight px-2 py-1 not-italic text-base">nuxt.config.js</span>
        </p>
        <pre class="app-code">
<code>css: ['~/assets/tailwind.css', '~/assets/styles.scss']</code></pre>

        <p class="text-lg mb-4">Change <span class="bg-highlight px-2 py-1 not-italic text-base">app.vue</span></p>
        <pre class="app-code">
<code>&lt;template&gt;
    &lt;NuxtLayout&gt;
        &lt;NuxtPage /&gt;
...
&lt;/template&gt;</code></pre>
        ...
        <p class="text-lg mb-4">Create <span class="bg-highlight px-2 py-1 not-italic text-base">layouts/default.vue</span> and paste this code:</p>
        <pre class="app-code">
<code>&lt;script setup&gt;
...
&lt;/template&gt;</code></pre>
        ...
        <p class="text-lg mb-4">
            Create <span class="bg-highlight px-2 py-1 not-italic text-base">layouts</span> folder and copy <span class="bg-highlight px-2 py-1 not-italic text-base">src/layout</span> folder and paste them. And then
            create <span class="bg-highlight px-2 py-1 not-italic text-base">composables/use-layout.vue</span> and replace it with
            <span class="bg-highlight px-2 py-1 not-italic text-base">src/layout/composables/layout.js</span>. Then remove this line:
        </p>
        <pre class="app-code">
